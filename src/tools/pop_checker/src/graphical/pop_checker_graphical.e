...
--							l_log.append_string ("%")
	...
	html_head (a_title: detachable STRING): STRING
		do
			...
			Result.append_string (" .jq {color: #F00; border-top: solid 2px #f00; }%N")
			Result.append_string ("</style>%N")
			Result.append_string ("<script type=%"text/javascript%" src=%"../jquery.js%"></script>%N")
			Result.append_string ("<script type=%"text/javascript%">%N")
